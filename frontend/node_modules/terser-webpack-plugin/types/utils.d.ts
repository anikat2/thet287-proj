...
export type ExtractCommentsOptions =
  import("terser-webpack-plugin").ExtractCommentsOptions;
export type ExtractCommentsFunction =
  import("terser-webpack-plugin").ExtractCommentsFunction;
export type ExtractCommentsCondition =
  import("terser-webpack-plugin").ExtractCommentsCondition;
export type Input = import("terser-webpack-plugin").Input;
export type MinimizedResult = import("terser-webpack-plugin").MinimizedResult;
export type CustomOptions = import("terser-webpack-plugin").CustomOptions;
export type RawSourceMap = import("terser-webpack-plugin").RawSourceMap;
export type PredefinedOptions<T> = import("terser-webpack-plugin").PredefinedOptions<T>;
